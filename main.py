...
N = Pop(start, #array with starting location coordonates
        ...
        0.09, #maximum consumption rate per person (pop^-1.year^-1)
        2, #R needed to reach half of maximum consumption rate (res)
        0.02, #population generated by max consumption (pop)
        0.02, #pop natural death rate (year^-1)
        20, # carrying capacity (pop)
        500) #Diffusion coefficient
...
sim = Grid(N,
           ...
           31,# power decline speed with money (money)
